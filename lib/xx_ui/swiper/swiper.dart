...
import 'package:xx_vendor/xx_ui/swiper/swiper_pagination.dart';
import 'package:xx_vendor/xx_ui/swiper/transformer_page_view/transformer_page_view.dart';
...
class XXSwiper extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _XXSwiperState();
  }
}

abstract class _SwiperTimerMixin extends State<XXSwiper> {
  Timer? _timer;
  ...
  @override
  void didUpdateWidget(XXSwiper oldWidget) {
...
class _XXSwiperState extends _SwiperTimerMixin {
  int _activeIndex = 0;
  ...
  bool _getReverse(XXSwiper widget) =>
      widget.transformer == null ? false : widget.transformer!.reverse;
