...
class XXSwitch extends StatefulWidget {
  const XXSwitch({
    Key? key,
    required this.value,
    ...
    this.activeColor,
    this.activeGradient =
        const LinearGradient(colors: [Color(0xffFFAF62), Color(0xffFF7733)]),
    this.inactiveColor,
  ...
  @override
  _XXSwitchState createState() => _XXSwitchState();
}

class _XXSwitchState extends State<XXSwitch>
  ...
  @override
  void didUpdateWidget(XXSwitch oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.value) {
      ...
      switchGradient = widget.activeGradient;
    } else {
      ...
      toggleBorder = widget.inactiveToggleBorder as Border? ??
          widget.toggleBorder as Border?;
      switchGradient = widget.inactiveGradient;
    }
